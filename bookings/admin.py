...
class BookingAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "booking_date", "time_slot", "table"]
    ...
    def status_display(self, obj):
        status_colors = {"confirmed": "green", "pending": "orange", "cancelled": "red"}
    ...
    def confirm_booking(self, request, object_id):
        ...
        messages.success(
            request, f"Бронирование столика {booking.table.number} подтверждено!"
        )
    ...
    def cancel_booking(self, request, object_id):
        ...
        messages.success(
            request, f"Бронирование столика {booking.table.number} отменено!"
        )
        return redirect("admin:bookings_booking_changelist")
