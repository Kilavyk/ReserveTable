...
def _handle_table_operation(request, operation_type, table_id=None):
    ...
    try:
        number, max_guests, description, is_active = _extract_table_data_from_request(request)
        ...
        messages.error(request, f'Произошла ошибка при {operation_name} столика: {str(e)}')
