    ...
    if request.method == 'POST':
        ...
        try:
            ...
            owner_message_html = render_to_string(
                'core/emails/feedback_to_owner.html',
                context
            )
            ...
            if email and is_valid_email(email):
                ...
                user_message_html = render_to_string(
                    'core/emails/feedback_to_user.html',
                    context
                )
                ...
                messages.success(request, 'Ваше сообщение успешно отправлено! Мы свяжемся с вами при необходимости.')
            else:
